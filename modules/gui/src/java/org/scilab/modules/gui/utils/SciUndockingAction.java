...
public class SciUndockingAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        /*SwingScilabPanel xcosTab=SwingScilabWindow.getPanelXcosTabList((SwingScilabPanel)associatedTab);
        List<SwingScilabPanel>panelList=SwingScilabWindow.getXcosTabPanelList(xcosTab);
        if(panelList!=null) {
            panelList.add(newWindow.getId());
            SwingScilabWindow.putWindowList(xcosTab,windowList);
        }*/
        List<SwingScilabPanel>windowPanelList=new ArrayList<SwingScilabPanel>();
        windowPanelList.add(associatedTab);
        SwingScilabWindow.putWindowPanelList(newWindow.getId(),windowPanelList);
