...
public abstract class SwingScilabWindow extends JFrame implements SimpleWindow {
    ...
    public static Map<SwingScilabPanel, List<SwingScilabPanel>>xcosTabPanelList = new HashMap<SwingScilabPanel, List<SwingScilabPanel>>();
    public static Map<SwingScilabPanel, SwingScilabPanel>panelXcosTabList = new HashMap<SwingScilabPanel, SwingScilabPanel>();
    public static Map<String, List<SwingScilabPanel>>windowPanelList = new HashMap<String, List<SwingScilabPanel>>();
    public static SwingScilabPanel simulationStartedTab;
    
    public static SwingScilabWindow getWindow(String windowUID) {
        return allScilabWindows.get(windowUID);
    }
    public static Map<String, SwingScilabWindow> getallScilabWindows() {
        return allScilabWindows;
    }
    public static void setSST(SwingScilabPanel xcosTab) {
        simulationStartedTab = xcosTab;
    }
    public static SwingScilabPanel getSST() {
        return simulationStartedTab;
    }
    public static void putXcosTabPanelList(SwingScilabPanel xcosTab, List<SwingScilabPanel>PanelList) {
        xcosTabPanelList.put(xcosTab,PanelList);
    }
    public static List<SwingScilabPanel> getXcosTabPanelList(SwingScilabPanel xcosTab) {
        return xcosTabPanelList.get(xcosTab);
    }
    public static void putPanelXcosTabList(SwingScilabPanel panel, SwingScilabPanel xcosTab) {
        panelXcosTabList.put(panel,xcosTab);
    }
    public static SwingScilabPanel getPanelXcosTabList(SwingScilabPanel panel) {
        return panelXcosTabList.get(panel);
    }
    public static void putWindowPanelList(String windowID, List<SwingScilabPanel>PanelList) {
        windowPanelList.put(windowID,PanelList);
    }
    public static List<SwingScilabPanel> getWindowPanelList(String windowID) {
        return windowPanelList.get(windowID);
    }
