        ...
        if (allDiagrams.size() == 1) {
            ...
            addTo.setCallback(new CommonCallBack(cmd) {
                ...
                public void callBack() {
                    ctrl.getPaletteCtrl().addSelectedBlocks(theDiagram,0);
                }
            });
            menu.add(addTo);
        } else {
            ...
            for (int i = 0; i < allDiagrams.size(); i++) {
                ...
                diagram.setCallback(new CommonCallBack(cmd) {
                    ...
                    @Override
                    public void callBack() {
                        ctrl.getPaletteCtrl().addSelectedBlocks(theDiagram,ind);
                    }
                });
                addTo.add(diagram);
            }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if ((e.getClickCount() == 1 && SwingUtilities.isRightMouseButton(e))
            ...
            if (e.getClickCount() == 1) {
                ...
                blockCtrl.getPaletteCtrl().addSelectedBlocks(theDiagram,allDiagrams.size()-1);
                PaletteCtrl.clearSelections();
            }
        } else {
            return;
